...
runParser = (mapLeft (joinToString >>> append "Expected: ") .) . execParser
...
evalParser :: Eq t => Parser t a -> [t] -> Either ExpectedTokens ([t], a)
...
algebra1 :: Eq t => ParserOp t a -> [t] -> Either ExpectedTokens ([t], a)
